...
> **I Love Perfume**는 향수를 사랑하는 사람들이 모여 시향 기록을 남기고 자유롭게 소통하는 커뮤니티입니다. 향수 사진을 업로드하면 AI가 제품 정보를 분석해 등록 폼을 자동으로 채워 주며, 실시간 채팅으로 다른 사용자와 소통하고, AI 어시스턴트에게 향수 추천이나 궁금한 점을 물어볼 수 있는 풀스택 웹 애플리케이션입니다.
...
**I Love Perfume**는 Next.js 15 App Router 기반의 풀스택 웹 애플리케이션입니다. 향수 탐색부터 등록, 리뷰 작성, 실시간 채팅, AI 어시스턴트까지 한 흐름으로 이용할 수 있습니다.
