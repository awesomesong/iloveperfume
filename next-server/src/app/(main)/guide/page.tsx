...
export const metadata: Metadata = {
  title: 'I Love Perfume 소개 및 이용 안내',
  description:
    'I Love Perfume는 향수를 수집하고 기록하는 프론트엔드 포트폴리오 사이트입니다. 서비스 소개와 이용 방법을 안내합니다.',
  openGraph: {
    title: 'I Love Perfume 소개 및 이용 안내',
    description:
      'I Love Perfume는 향수를 수집하고 기록하는 프론트엔드 포트폴리오 사이트입니다. 서비스 소개와 이용 방법을 안내합니다.',
...
const mainGalleryGuide: MainGalleryGuide = {
  ...
  desc: [
    <span key="1">메인 페이지는 상단의 <strong>기능 이용 안내</strong>와 그 아래 <strong>시그니처 향수 갤러리</strong>로 구성되어 있으며, 아래로 스크롤 하면 갤러리로 자연스럽게 이어집니다.</span>,
